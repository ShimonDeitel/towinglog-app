...
struct ContentView: View {
    ...
    @State private var editingItem: TowEvent?
    ...
    private func editSheet(for item: TowEvent) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: TowEvent
    var onSave: (TowEvent) -> Void
    var onDelete: () -> Void
